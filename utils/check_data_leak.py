...
def check_train_test(args):
    ...
    for dataset_name in result:
        ...
        check_inverse_relation_not_to_exist(train_data_, test_data_, out_dir_path,entity2id_inv, relation2id_inv, "")


print("example run: python check_inverse_data_leak.py --path ../Datasets/FB15K_H/Transductive")
